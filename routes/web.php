...
|
*/
Route::get('/units/1/products',  function () {
    $unit = Unit::find(17);
  $activites = $unit->activites;
  $familles = $activites->flatMap(function ($activite) {
    return $activite->familles;
  });
  $produits = $familles->flatMap(function ($famille) {
...
Route::middleware(['auth', 'role:visiteur'])->group(function () {
  Route::resource('visiteur',AdminsController::class);
});
